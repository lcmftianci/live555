...
DummySink::DummySink(UsageEnvironment& env, MediaSubsession& subsession, char const* streamId)
	...
	H264VideoFileSink* fileSink = H264VideoFileSink::createNew(env, outFileName, fSubsession.fmtp_spropparametersets());
...
void DummySink::afterGettingFrame(unsigned frameSize, unsigned numTruncatedBytes,
	...
	H264_2_RGB(tmpby, frameSize - 4, RgbBuf, &RgbSize, &RgbWidth, &RgbHeight);
